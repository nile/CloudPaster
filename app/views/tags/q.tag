...
#{a @UserCenter.index()}${paster?.creator.name}#{/a} 发表于 ${paster?.created?.freindly()}
#{if paster?.updated} &nbsp; #{a @UserCenter.index()}${paster?.creator.name}#{/a} 修改于 ${paster?.updated.freindly()}#{/if}
</td>
</tr>
</table>
